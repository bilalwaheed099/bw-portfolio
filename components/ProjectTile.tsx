...
export const ProjectTile = ({
  ...
  return (
    <Link href={url} className="relative z-100">
      <div
        className={`text-center md:text-start text-white bg-gray-300/10 p-6 rounded-xl w-full cursor-pointer hover:scale-[102%] hover:bg-gray-100/20 transition`}
      ...
      >
        ...
        <p className="mt-4 font-semibold text-gray-200 flex flex-wrap justify-center md:justify-normal gap-3">
          {techs.map((tech) => (
